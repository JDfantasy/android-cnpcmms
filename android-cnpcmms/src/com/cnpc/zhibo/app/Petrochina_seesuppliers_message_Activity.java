...
public class Petrochina_seesuppliers_message_Activity extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_petrochina_seesuppliers_message);
		setview();
	...
	private AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			Intent in = new Intent(Petrochina_seesuppliers_message_Activity.this,
					Petrochina_see_station_repairsmessageActivity.class);
			in.putExtra("id", adapter.getData().get(position).id);
			startActivity(in);
			Myutil.set_activity_open(Petrochina_seesuppliers_message_Activity.this);
	...
	private void setview() {
		set_title_text("供应商信息");
		back = (ImageView) findViewById(R.id.imageView_myacitity_zuo);
		back.setVisibility(View.VISIBLE);
		back.setOnClickListener(l);
		stationmonads = (TextView) findViewById(R.id.textview_petrochina_seesuppliers_message_servicemonads);
		stationmessage = (TextView) findViewById(R.id.textview_petrochina_seesuppliers_message_suppliersmessage);
		web = (WebView) findViewById(R.id.webview_petrochina_seesuppliers_message);
		line = (LinearLayout) findViewById(R.id.linearlayout_petrochina_seesuppliers_message);
		web.loadUrl(Myconstant.PROVIDERMESSAGE + getIntent().getStringExtra("id"));
		

		stationmonads.setOnClickListener(l);
		stationmessage.setOnClickListener(l);
		list = (ListView) findViewById(R.id.listview_petrochina_seesuppliers_message_stationmonads);
		...
		stationmessage.setText(Html.fromHtml("<u>" + "供应商信息" + "</u>"));
		stationmonads.setTextColor(getResources().getColor(R.color.zitiyanse5));
		stationmonads.setText("服务记录");
	...
	private View.OnClickListener l = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.imageView_myacitity_zuo:// 返回键
				finish();
				Myutil.set_activity_close(Petrochina_seesuppliers_message_Activity.this);

				break;
			case R.id.textview_petrochina_seesuppliers_message_servicemonads:// 查看供应商的服务项目的列表
				line.setVisibility(View.VISIBLE);
				web.setVisibility(View.INVISIBLE);
				stationmonads.setTextColor(getResources().getColor(R.color.blue));
				stationmonads.setText(Html.fromHtml("<u>" + "服务记录" + "</u>"));
				stationmessage.setTextColor(getResources().getColor(R.color.zitiyanse5));
				stationmessage.setText("供应商信息");
				break;
			case R.id.textview_petrochina_seesuppliers_message_suppliersmessage:// 查看供应商信息
				stationmessage.setTextColor(getResources().getColor(R.color.blue));
				stationmessage.setText(Html.fromHtml("<u>" + "供应商信息" + "</u>"));
				stationmonads.setTextColor(getResources().getColor(R.color.zitiyanse5));
				stationmonads.setText("服务记录");
	...
	private void set_entryaddddata() {
		...
		String url = Myconstant.PETROCHINA_GET_PROVIDERENTRYFIXORDER + "id=" + getIntent().getStringExtra("id")
		...
		StringRequest re = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
			...
			public void onResponse(String response) {
				try {
					...
					if (js1.getString("type").equals("success")) {
						Toast.makeText(Petrochina_seesuppliers_message_Activity.this, js1.getString("content"), 0)
								.show();
			...
			public void onErrorResponse(VolleyError error) {
				...
				Toast.makeText(Petrochina_seesuppliers_message_Activity.this, "你已经掉线，请重新登录", 0).show();
			}
		}) {
			@Override
